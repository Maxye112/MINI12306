...
{
	DWORD BC = RGB(51, 126, 251); DWORD HC = RGB(17, 94, 188);
	m_bkColor = BC;//默认是蓝色风格背景
	m_hoverColor = HC;//默认高亮色
...
CCustomDrawBtn::CCustomDrawBtn(DWORD BC = RGB(51, 126, 251), DWORD HC = RGB(17, 94, 188))
{
	m_bkColor = BC;//默认是蓝色风格背景
	m_hoverColor = HC;//默认高亮色
	m_textColor = RGB(255, 255, 255);//默认文字颜色
